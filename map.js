...
function lengthsOf(strings) {
  return strings.map((string) => getLength(string));
}

const stringCollection = ["apple", "banana", "kiwi"];
console.log(lengthsOf(stringCollection));
//------------------------------------------------------------------------------
...
const reversedArraysOf = function (arrayOfArrays) {
  return arrayOfArrays.map(function (array) {
...
const removeVowels = function (stringWithOutVowels, letter) {
  const vowels = ["a", "e", "i", "o", "u", "A", "E", "I", "O", "U"];
...
const withoutVowelsOf = function (strings) {
  return strings.map(function (string) {
    return [...string].reduce(removeVowels, "");
  });
};
...
const mathScores = function () {};

// extract coordinates from [{ x: 1, y: 2 }, { x: 3, y: 4 }] => [[1, 2], [3, 4]]
const extractCoordinates = function () {};
...
const normalizeStringLengths = function () {};
...
const normalizeWithCurve = function () {};
...
const sortByLengthAndAlphabet = function () {};
...
const normalizeByRange = function () {};
...
const percentageOfTotalSorted = function () {};
...
const sortStudentsByAverage = function () {};
...
const mapToBinaryAndGroup = function () {};
...
const flattenAndFilterEven = function () {};
...
const filterAdultsAndSort = function () {};
...
const totalSalesByMonth = function () {};
...
const totalSalaryByDepartment = function () {};
...
const highestGradeByStudent = function () {};
...
const categorizeBooksByYear = function () {};
...
const totalSpentByUser = function () {};
...
const finalPriceAfterDiscount = function () {};
...
const flattenOrderItems = function () {};
...
const prefixWithIndex = function () {};
...
const discountByIndex = function () {};
...
const formatNamesWithIndex = function () {};
...
const formatNamesWithAge = function () {};
...
const extractHashtags = function () {};
...
const addReplyNoteToComments = function () {};
...
const capitalizeCommentsIfPopular = function () {};
...
const combineNameAndTitle = function () {};
...
// [1, 2, 3], [2, 3, 4] => [2, 6, 12]
const multiplyByCorresponding = function () {};
...
const calculateRetirement = function () {};
...
// [5, 10, 15], 10 => [10, 15]
const filterGreaterThanEqual = function () {};
...
const checkAdultStatus = function () {};
...
const getUserPostTitles = function () {};
...
const formatProductTags = function (products) {
  return products.map(({ name, tags }) => {
    const productsInUpperCase = tags.map((name) => name.toUpperCase());
    return { name, products: productsInUpperCase };
  });
};
...
const getCategoryItems = function (categories) {
  return categories.map(({ categoryName, items }) => {
    ...
    return { categoryName, items: names };
  });
};

console.log(
  getCategoryItems([
    { categoryName: "Fruits", items: [{ name: "Apple" }, { name: "Banana" }] },
    { categoryName: "Vegetables", items: [{ name: "Carrot" }] },
  ])
);
//==============================================================================
...
const summarizeOrderProducts = function (orders) {
  return orders.map(({ orderId, products }) => {
    const productObject = products.map(({ name, quantity }) => {
      return name + " " + "x" + quantity;
    });

    return { orderId, products: productObject };
  });
};
...
//     const courseNamesInUpperCase = student.courses.map((course) =>
//       course.courseName.toUpperCase()
//     );

//     const objectOfCoursesInUpperCase = {};
//     objectOfCoursesInUpperCase["name"] = student.name;
//     objectOfCoursesInUpperCase["courses"] = courseNamesInUpperCase;

//     return objectOfCoursesInUpperCase;
//   });
// };
...
//     {
//       name: "Alice",
//       courses: [{ courseName: "Math" }, { courseName: "Science" }],
//     },
//     { name: "Bob", courses: [{ courseName: "English" }] },
//   ])
// );
...
//     const mergedChapters = book.chapters.map((chapter) => {
//       const chapterObject = {};
//       chapterObject[chapter.title] = chapter.pageCount + " " + "pages";
//       return chapterObject;
//     });

//     const arrayOfMergedBooks = {};
//     arrayOfMergedBooks["title"] = book.title;
//     arrayOfMergedBooks["chapter"] = mergedChapters;
//     return arrayOfMergedBooks;
//   });
// };
...
//     const attendees = individualEvent.attendees.map((attendee) =>
//       attendee.firstName.concat(" ", attendee.lastName)
//     );
//     const combinedObject = {};
//     combinedObject["name"] = individualEvent.name;
//     combinedObject["attendees"] = attendees;
